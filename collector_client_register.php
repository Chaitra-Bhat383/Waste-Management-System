        ...
        <div >
                <div class="card" style="background-color:darkblue;width: 2000px;height:100px">
                    <div class="card-body">
                        ...
                        <div class="btn-list">
                            <a href="collector_client_register.php?user=<?php echo $_SESSION['username']; ?>"><button type="button"
                                class="btn waves-effect waves-light btn-rounded btn-primary">New Client</button></a>
                    
                             <a href="collector_client_list.php?user=<?php echo $_SESSION['username']; ?>"><button type="button"
                                      ...
                                      <option selected value="">---Choose---</option>
                                       ...
                                       <option value="individual">Individual </option> 
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                        <select type = "text" name="location" required class="form-control" required    >
                                            <option selected value="">---Choose---</option>
                                            <option > 1 </option> 
                                            <option > 2 </option>
                                        </select>
...
<div class="row">
 ...
 <select name="gabage_type" class="form-control show-tick" required data-live-search="true">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="collector_client_list.php?user=<?php echo $_SESSION['username']; ?>"><button type="submit"  name="submit" class="btn btn-info">REGISTER CLIENT</button></a>
