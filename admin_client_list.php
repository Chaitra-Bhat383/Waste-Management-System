...
<div class="row">
 ...
 <select name="gabage_type" class="form-control show-tick" required data-live-search="true">
   ...
   <?php 
                           ...
                           <div class="table-responsive">
                                ...
                                <tbody>
                                 ...
                                 <td><?php echo $hk['contact'];?></td>
                                            ...
                                            <td><a href="admin_update_client.php?id=<?php echo $hk['id']; ?>"> Update User Account </a></td>
                    ...
                    <span style="font-size: 160%;color:darkblue">
                    <?php echo "The total number of Clients in lane One is  ". $x;
                    echo " \r\n"; ?>
                    </span>
                ...
                <div class="col-12">
                <span style="font-size: 160%;color:darkblue">
                <?php echo "   The total number of Clients in lane Two is  ". $y?></div>
                </span>
