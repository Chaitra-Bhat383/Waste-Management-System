...
<head>
    ...
    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="vendors/images/waste.png">
    <link rel="icon" type="image/png" sizes="32x32" href="vendors/images/waste.png">
    <link rel="icon" type="image/png" sizes="16x16" href="vendors/images/waste.png">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-7">
                    <img src="vendors/images/waste.png" alt="" width="700" height="600">
                </div>
