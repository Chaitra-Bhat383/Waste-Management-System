                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <select name="status" class="form-control show-tick" required data-live-search="true">
                                                        ...
                                                        <option value="Approved-Mini" <?php echo $res['status'] == 'Approved-Mini' ? 'selected' : '' ?>>Approved-Mini </option>
                                                        <option value="Approved-Truck" <?php echo $res['status'] == 'Approved-Truck' ? 'selected' : '' ?>>Approved-Truck </option>
