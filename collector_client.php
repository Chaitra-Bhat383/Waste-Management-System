             ...
             <div>
                        <div class="card" style="background-color:darkblue;width: 2000px;height:100px">
                            <div class="card-body">
                              ...
                              <a href="collector_view_payments.php?user=<?php echo $_SESSION['username']; ?>"><button type="button"
                    ...
                    <div class="col-12">
                        <div class="card">
                           ...
                           <div class="table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        <td><a href="collector_payment.php?id=<?php echo $hk['id']; ?>"><?php echo $hk['names'];?></a></td>
