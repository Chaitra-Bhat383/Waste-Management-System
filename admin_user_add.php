...
include 'aaside.php'; ?>
    ...
    <input type="text" title="What is the name of this user? " name="fullname" required  class="form-control" placeholder="Enter the name">
                                      ...
                                      <option selected value="">---Choose---</option>
                                       ...
                                       <option value="collector"> Collector</option> 
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
            <input type="text" required  class="form-control" placeholder="Enter the contact of the user you are registering">
   </div>
                                            </div>
                                        </div>
                                         <div class="row">
...
$query=mysqli_query($con,"INSERT INTO admin (username,password,fullname,ucat,address,contact,acstatus,date,image) VALUES('$username','$password','$fullname','$ucat','$address','$contact','$acstatus','$date','$file')");
        ...
        if ($query) {
            echo "successfull";
            echo("<script>location.href='admin_user_list.php';</script>");
